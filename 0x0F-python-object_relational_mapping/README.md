...
### 14. Cities in state
Write a Python file similar to [model_state.py](./model_state.py) named [model_city.py](./model_city.py) that contains the class definition of a `City`.
...
Files: [relationship_city.py](./relationship_city.py), [relationship_state.py](./relationship_state.py), [100-relationship_states_cities.py](./100-relationship_states_cities.py)
